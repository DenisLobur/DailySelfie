...
public class SelfieStorageUtils {
    ...
    public static Uri getSelfieUri(Context context) {
        ...
        if (isExternalStorageWritable()) {
            ...
            final File selfieStorageDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM);
            ...
            final String timeStamp = new SimpleDateFormat("MMddHHmm").format(new Date());
            
            // Create a selfie file name from the TimeStamp.
            final File selfieFile = new File(selfieStorageDir.getPath() + File.separator + timeStamp);
