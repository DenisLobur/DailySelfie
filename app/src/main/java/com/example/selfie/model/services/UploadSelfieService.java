 ...
 */
public class UploadSelfieService extends IntentService {
    /**
     * Custom Action that will be used to send Broadcast to the
     * SelfieListActivity.
     */
    public static final String ACTION_UPLOAD_SERVICE_RESPONSE =
                "coursera.assignment3client.services.UploadSelfieService.RESPONSE";
     ...
     * @return
     */
    public static Intent makeIntent(Context context, Uri selfieUri) {
        return new Intent(context, UploadSelfieService.class).setData(selfieUri);
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        finishNotification(mSelfieMediator.uploadSelfie(getApplicationContext(), intent.getData()));
